...
var UpdateCommentInput = /** @class */ (function () {
...
var CommentResolver = /** @class */ (function () {
    ...
    CommentResolver.prototype.comments = function () {
    ...
    CommentResolver.prototype.createComment = function (content) {
        return __awaiter(this, void 0, void 0, function () {
            var comment;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    CommentResolver.prototype.deleteComment = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var comment;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Comment_1.default.findOneOrFail({ id: id })];
                    case 1:
                        comment = _a.sent();
                        return [4 /*yield*/, Comment_1.default.remove(comment)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/, comment];
                }
    ...
    CommentResolver.prototype.updateComment = function (_a) {
        var id = _a.id, content = _a.content;
        return __awaiter(this, void 0, void 0, function () {
            var comment, updatedAt, updatedProjectRole;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        comment = _b.sent();
                        updatedAt = new Date();
                        return [4 /*yield*/, Comment_1.default.update(comment, { content: content, updatedAt: updatedAt })];
                    case 2:
                        _b.sent();
                        return [4 /*yield*/, Comment_1.default.findOneOrFail({ id: id })];
                    case 3:
    ...
    __decorate([
        (0, type_graphql_1.Query)(function () { return [Comment_1.default]; }),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
        __metadata("design:returntype", Promise)
    ], CommentResolver.prototype, "comments", null);
    __decorate([
        (0, type_graphql_1.Mutation)(function () { return Comment_1.default; }),
    ...
    CommentResolver = __decorate([
        (0, type_graphql_1.Resolver)(Comment_1.default)
    ], CommentResolver);
